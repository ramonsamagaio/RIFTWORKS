...
def _spawn_salvage(actors, cls, name, location, item_id, display_name, amount=1, heavy=False, mass=2.0):
    actor = actors.spawn_actor_from_class(cls, unreal.Vector(*location), _rotator())
    if not actor:
        return None
    try:
...
def _stage_hostiles(by_label):
    positions = {
        "RIFT_AUTO_Humanoid_00": (1560, 1320, 105),
        "RIFT_AUTO_Humanoid_01": (-1760, -1420, 105),
        "RIFT_AUTO_Humanoid_02": (-620, -2180, 105),
        "RIFT_AUTO_Humanoid_03": (-640, -7500, -820),
        "RIFT_AUTO_Humanoid_04": (620, -10200, -1240),
